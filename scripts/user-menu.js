  ...
  if (currentUser) {
    ...
    if (currentUser.isVerifiedForRoutes) {
      ...
      userMenu.innerHTML = `
        ...
        <a href="login-security.html" class="menu-item">
          <span class="menu-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="your-routes.html" class="menu-item">
          <span class="menu-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="social-links">
          ...
          <a href="#" class="social-link">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              ...
              <path d="M7.5 3.5h9l3 3v9l-3 3h-9l-3-3v-9z"></path>
              <path d="M3.5 7.5L7.5 3.5"></path>
              <path d="M16.5 20.5l3-3"></path>
              <path d="M16.5 3.5l3 3"></path>
              <path d="M3.5 16.5l4 4"></path>
            </svg>
          </a>
          <a href="#" class="social-link">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <path d="M21.5 2l-3 12.5-5-3 4-4-6 6 2 8z"></path>
              <path d="M14 22l1-7-7-4"></path>
            </svg>
          </a>
        </div>
      `
      ...
      userMenu.innerHTML = `
        ...
        ${
          currentUser.hasSubmittedVerificationForm
            ...
            : `<button class="verify-routes-btn">
                <span class="icon-plus">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <line x1="12" y1="5" x2="12" y2="19"></line>
                    <line x1="5" y1="12" x2="19" y2="12"></line>
